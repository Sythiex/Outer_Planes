...
public class PortalElysium extends BlockPortal
{
	...
	public boolean func_150000_e(World par1World, int par2, int par3, int par4)
	{
		...
		if (par1World.getBlock(par2 - 1, par3, par4) == portalFrameBlockElysium || par1World.getBlock(par2 + 1, par3, par4) == portalFrameBlockElysium)
		{
			b0 = 1;
		}
		
		if (par1World.getBlock(par2, par3, par4 - 1) == portalFrameBlockElysium || par1World.getBlock(par2, par3, par4 + 1) == portalFrameBlockElysium)
		{
			b1 = 1;
		}
		...
		else
		{
			...
			for (l = 0; l < 2; ++l)
			{
				for (i1 = 0; i1 < 3; ++i1)
				{
					par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, OuterPlanes.portalBlockElysium, 0, 2);
				}
			}

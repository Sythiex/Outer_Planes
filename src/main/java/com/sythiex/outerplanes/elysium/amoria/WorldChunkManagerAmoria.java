...
import com.sythiex.outerplanes.elysium.amoria.layer.GenLayerAmoria;
...
public class WorldChunkManagerAmoria extends WorldChunkManager
{
	...
	public WorldChunkManagerAmoria()
	{
	...
	public WorldChunkManagerAmoria(long seed, WorldType worldType)
	{
		this();
		GenLayer[] agenlayer = GenLayerAmoria.initializeAllBiomeGenerators(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}
	
	public WorldChunkManagerAmoria(World world)
	{

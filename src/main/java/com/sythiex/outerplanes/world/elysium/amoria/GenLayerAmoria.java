...
public abstract class GenLayerAmoria extends GenLayer
{
	 ...
	 * @param seed
	 * @param worldType
	 * @return final array of genlayers
	 */
	...
	{
		GenLayer genlayer = new GenLayerBiomesAmoria(200L, parentLayer);
		genlayer = GenLayerZoom.magnify(1000L, genlayer, 2);
		genlayer = new GenLayerBiomeEdge(1000L, genlayer);
		return genlayer;
	}
}
